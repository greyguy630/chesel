        ...
        <div className="w-full max-w-md space-y-6">
          ...
          <div className="space-y-4">
            <button
              ...
              className="w-full bg-white/80 backdrop-blur-sm border border-gray-200/50 rounded-2xl p-6 text-left hover:bg-white hover:shadow-xl transition-all duration-300"
            >
            ...
            <button className="w-full bg-white/80 backdrop-blur-sm border border-gray-200/50 rounded-2xl p-6 text-left hover:bg-white hover:shadow-xl transition-all duration-300">
              <div className="flex items-center space-x-4">
  ...
  if (mode === 'review') {
    return (
      <div className="p-6 space-y-6">
        ...
        <div className="space-y-4">
          <div className="bg-white/80 backdrop-blur-sm border-2 border-dashed border-gray-300 rounded-2xl p-8 text-center">
            <Upload className="w-12 h-12 text-gray-400 mx-auto mb-4" />
            <p className="text-gray-600 mb-4">Upload Your Outfit</p>
            <button className="bg-gradient-to-r from-purple-500 to-pink-600 text-white px-6 py-3 rounded-xl font-medium">
              Choose Photo
            </button>
          </div>
          ...
          <button
            ...
            className="w-full bg-gradient-to-r from-indigo-500 to-purple-600 text-white py-4 rounded-2xl font-medium hover:shadow-lg transition-all duration-200"
          >
            Analyze Outfit
          </button>
        </div>
      ...
      <div className="grid grid-cols-1 gap-4">
        <div className="bg-white/80 backdrop-blur-sm border border-gray-200/50 rounded-2xl p-6 text-center shadow-lg">
          ...
          <div className="w-full bg-gray-200 rounded-full h-2">
            <div className="bg-gradient-to-r from-purple-500 to-pink-600 h-2 rounded-full" style={{ width: '82%' }}></div>
          </div>
        </div>
